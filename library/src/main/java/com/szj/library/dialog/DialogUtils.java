...
public class DialogUtils {
    ...
    public static void showKeyboard(DialogInterface di, final MTFDialog.Builder builder) {
        final MTFDialog dialog = (MTFDialog) di;
    ...
    public static void hideKeyboard(DialogInterface di, final MTFDialog.Builder builder) {
        final MTFDialog dialog = (MTFDialog) di;
        if (dialog.getInputEditText() == null) return;
        dialog.getInputEditText().post(new Runnable() {
            @Override
