package com.szj.library.dialog.normal.internal;
...
import com.szj.library.dialog.DialogUtils;
import com.szj.library.dialog.GravityEnum;
import com.szj.library.dialog.MDButton;
import com.szj.library.dialog.MTFDialog;
...
public class MDRootLayout extends ViewGroup {
    ...
    public static boolean canRecyclerViewScroll(RecyclerView view) {
        ...
        if (lm instanceof LinearLayoutManager) {
            ...
            throw new MTFDialog.NotImplementedException("Material Dialogs currently only supports LinearLayoutManager. Please report any new layout managers.");
        }
