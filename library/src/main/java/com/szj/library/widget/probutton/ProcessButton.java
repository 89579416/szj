package com.szj.library.widget.probutton;
...
public abstract class ProcessButton extends FlatButton {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mProgressDrawable = (GradientDrawable) getDrawable(R.drawable.mtf_probutton_rect_progress).mutate();
        mProgressDrawable.setCornerRadius(getCornerRadius());

        mCompleteDrawable = (GradientDrawable) getDrawable(R.drawable.mtf_probutton_rect_complete).mutate();
        mCompleteDrawable.setCornerRadius(getCornerRadius());

        mErrorDrawable = (GradientDrawable) getDrawable(R.drawable.mtf_probutton_rect_error).mutate();
    ...
    private void initAttributes(Context context, AttributeSet attributeSet) {
        ...
        try {
            ...
            int purple = getColor(R.color.mtf_gray_400);
