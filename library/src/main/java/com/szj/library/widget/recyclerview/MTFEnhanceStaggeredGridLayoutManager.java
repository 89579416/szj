 ...
 */
public class MTFEnhanceStaggeredGridLayoutManager extends StaggeredGridLayoutManager {

    private final String TAG = getClass().getSimpleName();

    GridLayoutManager.SpanSizeLookup mSpanSizeLookup;

    public MTFEnhanceStaggeredGridLayoutManager(int spanCount, int orientation) {
