 ...
 */
public class MTFRecyclerViewAdapterWrapper extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public MTFRecyclerViewAdapterWrapper() {
    }

    public MTFRecyclerViewAdapterWrapper(RecyclerView.Adapter innerAdapter) {
