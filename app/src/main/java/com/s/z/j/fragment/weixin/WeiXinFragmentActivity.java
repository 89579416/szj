package com.s.z.j.fragment.weixin;
 ...
 */
public class WeiXinFragmentActivity extends FragmentActivity implements OnGestureListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fragment_weixin);
...
//        linearLayouts[0].setBackgroundResource(R.drawable.lay_select_bg);
        linearLayouts[1].setBackgroundColor(getResources().getColor(R.color.white));
...
//            linearLayouts[1].setBackgroundColor(getResources().getColor(R.color.red_error));
